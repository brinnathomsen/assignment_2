...
function draw() {
	...
	if (weather > 70) {
		...
		fill(colorSail);
		triangle(328 + boatLocation, 180, 328 + boatLocation, 235, 280 + boatLocation,
			235);
		triangle(338 + boatLocation, 195, 338 + boatLocation, 235, 360 + boatLocation,
			235);
